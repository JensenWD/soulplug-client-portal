<div class="modal fade" id="adminAddItem" tabindex="-1" role="dialog" aria-labelledby="adminAddItem"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Add an item for a user</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('add-item') }}" method="post" class="p-4">
                    ...
                    <div class="form-group row">
                        <div class="col">
                            <label for="user_email" class="col-sm-1-12 col-form-label">User email</label>
                    ...
                    <div class="form-group row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="name" required placeholder="Supreme hoodie">
                        </div>
                    </div>
